...
class Site1Form(MultipleForm):
    oil_prod = forms.CharField(max_length=50, widget=forms.NumberInput(
    ...
    hardness = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость общая")
    salt = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Солесодержание")
    chlorides = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Хлориды")
    sulfates = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Сульфаты")
    iron = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Железо")
    hardness_calcium = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость кальциевая")
    hardness_magnesium = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site3Form(MultipleForm):
    suspended_subst = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Взвешенные вещества")
    hardness = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость общая")
    iron = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Железо")
    dry_residue = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site6Form(MultipleForm):
    ...
    suspended_subst = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Общие взвешенные вещества")
    alkalinity_phenols = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site10Form(MultipleForm):
    chlorine = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site12Form(MultipleForm):
    ...
    ph = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3', 'max':12, 'type': 'number'}), label="Значение pH")
    oxygen_chem = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Химическая потребность в кислороде (ХПК)")
    active_subst = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Поверхностно-активные вещества (АПАВ)")
    ammonium = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site13Form(MultipleForm):
    ...
    ammonium = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Аммонийный азот")
    oxygen_bio = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Биологическая потребность в кислороде (БПК5)")
    phenols = forms.CharField(max_length=50, widget=forms.NumberInput(
    ...
    iron = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Железо")
    nitrate = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Азот нитратов")
    nitrite = forms.CharField(max_length=50, widget=forms.NumberInput(
...
class Site14Form(MultipleForm):
    ...
    hardness = forms.CharField(max_length=50, widget=forms.NumberInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость общая")
    oxidability = forms.CharField(max_length=50, widget=forms.NumberInput(
