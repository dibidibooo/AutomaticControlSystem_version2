...
class Site1Form(MultipleForm):
    ...
    suspended_solids = forms.CharField(max_length=50, widget=forms.TextInput(
    ...
    phosphorus = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Фосфор")
    alkalinity = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Щёлочность общая")
    hardness = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость общая")
    salt = forms.CharField(max_length=50, widget=forms.TextInput(
    ...
    hardness_calcium = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость кальциевая")
    hardness_magnesium = forms.CharField(max_length=50, widget=forms.TextInput(
...
class Site3Form(MultipleForm):
    ...
    iron = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Железо")
    dry_residue = forms.CharField(max_length=50, widget=forms.TextInput(
...
class Site6Form(MultipleForm):
    ...
    suspended_subst = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Общие взвешенные вещества")
    alkalinity_phenols = forms.CharField(max_length=50, widget=forms.TextInput(
...
class Site10Form(MultipleForm):
    chlorine = forms.CharField(max_length=50, widget=forms.TextInput(
...
class Site14Form(MultipleForm):
    ...
    hardness = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control mb-3'}), label="Жёсткость общая")
    oxidability = forms.CharField(max_length=50, widget=forms.TextInput(
