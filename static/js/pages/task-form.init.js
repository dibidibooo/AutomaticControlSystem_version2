...
$(document).ready(function() {
    ...
    $("#NewtaskForm").validate({
        ...
        $("#updatetaskdetail").css("display", "none"), $("#addtask").css("display", "block"), $(".update-task-title").css("display", "none"), $(".add-task-title").css("display", "block"), $("#taskname").val(""), $("#taskdesc").val(""), $("#TaskStatus").val(""), $("#taskassignee input").prop("checked", !1), taskid = a
        ...
        $("#taskassignee input").prop("checked", !1), $(t).find(".task-assigne a").each(function() {
            ...
            $("#" + a).prop("checked", !0)
        }), $("#taskname").val(e), $("#taskdesc").val(s), $("#TaskStatus").val(l), selectedstatus = l
