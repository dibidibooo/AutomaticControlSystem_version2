...
class MobileApplicationClient(Client):
    ...
    def prepare_request_uri(self, uri, redirect_uri=None, scope=None,
        ...
        argument, set to ``token``::
            ...
            'https://enertek.kz?client_id=your_id&response_type=token'
            >>> client.prepare_request_uri('https://enertek.kz', redirect_uri='https://a.b/callback')
            'https://enertek.kz?client_id=your_id&response_type=token&redirect_uri=https%3A%2F%2Fa.b%2Fcallback'
            >>> client.prepare_request_uri('https://enertek.kz', scope=['profile', 'pictures'])
            'https://enertek.kz?client_id=your_id&response_type=token&scope=profile+pictures'
            >>> client.prepare_request_uri('https://enertek.kz', foo='bar')
            'https://enertek.kz?client_id=your_id&response_type=token&foo=bar'
    ...
    def parse_request_uri_response(self, uri, state=None, scope=None):
        ...
        **scope**
        ...
        A few example responses can be seen below::
            ...
            >>> response_uri = 'https://enertek.kz/callback#access_token=sdlfkj452&state=ss345asyht&token_type=Bearer&scope=hello+world'
            >>> from oauthlib.oauth2 import MobileApplicationClient
            >>> client = MobileApplicationClient('your_id')
