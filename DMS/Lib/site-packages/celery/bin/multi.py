...
.. code-block:: console
    ...
    $ celery multi start 2 --hostname=worker.enertek.kz -c 3
    celery worker -n celery1@worker.enertek.kz -c 3
    celery worker -n celery2@worker.enertek.kz -c 3

    $ # specify fully qualified nodenames
    $ celery multi start foo@worker.enertek.kz bar@worker.enertek.kz -c 3
