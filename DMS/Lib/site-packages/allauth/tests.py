...
class BasicTests(TestCase):
    ...
    def test_email_validation(self):
        s = "this.email.address.is.a.bit.too.long.but.should.still.validate@enertek.kz"  # noqa
    ...
    def test_build_absolute_uri(self):
        ...
        if not app_settings.SITES_ENABLED:
            ...
            request.META["SERVER_NAME"] = "enertek.kz"
        self.assertEqual(
            utils.build_absolute_uri(request, "/foo"), "http://enertek.kz/foo"
        )
        self.assertEqual(
